...
- [Basic Algorithm](./basic_routing_alg.md)
- [Customizable Route Planning (CRP)](https://github.com/Telenav/open-source-spec/blob/master/routing_basic/doc/crp.md)
- [Contraction Hierarchy (CH)](./ch.md)
- [Astar, Landmark, Triangle inequality (ALT)](./alt.md)
- [Reach](./reach.md)
- [Function class routing](https://github.com/Telenav/open-source-spec/blob/master/routing_basic/doc/function_class.md)
- [Time dependent routing](https://github.com/Telenav/open-source-spec/blob/master/routing_basic/doc/time_dependent_routing.md)
